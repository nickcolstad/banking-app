    ...
    switch (action.type) {
      ...
      case "usernameAfterDelay":
        if (draft.username.value.length < 3) {
          draft.username.hasErrors = true;
          draft.username.message = "Username must be more than 3 characters";
        }
    ...
    <Page wide={true} title="Welcome!">
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          ...
          <p className="lead text-muted">Are you tired of overly complicated banking applications? At BadBank, we keep it quick and easy for you to manage your money so you can get on with your daily life. </p>
        </div>
